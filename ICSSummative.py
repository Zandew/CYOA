...
bridge or to walk around the hole’)
    ...
    If ‘bridge’ in command:
         ...
         print (‘You safely crossed the hole’)
    pokecenter()
    guardroom()
...
print('The objective of this game is to defeat the boss and escape the locked room.')
print('You have to escape by battling pokemon. \
If you beat all the guards, you can face the boss!')
time.sleep(4)
print('Each pokemon has health and attack stats. The attack stat is split up\
...
allocate between health and attack.')
time.sleep(6)
print('Each pokemon is of a different type. There are grass,fire and water kinds.\
...
print('You have waken up in a room with no apparent exit other than two doors. \
...
def is_effective(pokemon1, pokemon2):
    if effectivedict[pokemon1.type] == pokemon2.type:
        return True
